  ...
  >
    <div v-if="windowWidth >= 600">
      <v-row dense>
        <v-spacer></v-spacer>
        <v-col cols="3">
          <v-img :src="images.logoAIT"></v-img>
        </v-col>

        <v-col cols="3">
          <v-img :src="images.logoCIL"> </v-img>
        </v-col>

        <v-col cols="3">
          <v-img :src="images.logoInfrared"> </v-img>
        </v-col>
      </v-row>
    </div>
...
@Component
export default class LogosAIT extends Vue {
  ...
  get activeMenuComponent(): string {
